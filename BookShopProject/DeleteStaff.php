...
<b id="logout"><a href="logout.php">Log Out</a></b>
       ...
       $name = $_POST['StaffName'];
        ...
        $query = "delete from staff where StaffName = '".$name."'";
...
<div id="login">
<h2>Delete Staff</h2>
<form action="DeleteStaff.php" method="post"><p> Name:</p>
...
$sql="SELECT StaffName FROM staff";
$result=  mysql_query($sql);

echo "<select  name='StaffName' type='text'>";
